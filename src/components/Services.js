...
const ServicesPage = () => {
  ...
  const [showDigitalMarketingDetails, setShowDigitalMarketingDetails] = useState(false);
  ...
  if (showHRDetails) {
    return <HRServices onClose={handleCloseDetails} />;
  }

  if (showDigitalMarketingDetails) {
    return <DigitalMarketingServices onClose={handleCloseDetails} />;
  }
    ...
    <div id='services' className="services-page-container">
      ...
      <div className="services-grid">
        ...
        <div id='hr-services' className="service-card">
          ...
          <button onClick={handleShowHRDetails} className="cta-button">Learn More About HR Services</button>
        </div>
        ...
        <div id='digital-marketing' className="service-card">
          ...
          <button onClick={handleShowDigitalMarketingDetails} className="cta-button">Learn More About Digital Marketing</button>
        </div>
      </div>
    </div>
  );
