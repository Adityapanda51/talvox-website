  ...
  return (
    <div id='contact' className="contact-us">
      ...
      <div className="get-in-touch">
        ...
        <p>We’d love to hear from you! Whether you have questions about our IT, HR, or Digital Marketing services, need support, or just want to connect, feel free to reach out to us. Our team is here to help you with all your needs. Reach out to us through any of the following methods:</p>
      </div>
    </div>
  );
};
